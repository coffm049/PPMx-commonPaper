...
# ============================================================================
# 08b-female-cvCombined-ABCD.jl
# Sex-stratified: FEMALE subjects only. 5-fold CV of PPMx-common.
# Output: output/baselines-female/combined5foldCV.csv
# ============================================================================
...
CSV.write("output/baselines-female/combined5foldCV.csv",
          DataFrame(fold = 1:5, rmse = rmsePerFold,
                    mean_rmse = fill(mean(rmsePerFold), 5)))
println("Combined 5-fold CV RMSE (female only): ", mean(rmsePerFold))
